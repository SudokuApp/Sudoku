...
class ScoreHandler {
    ...
    void compareToPrivate(int newScore){
        if (diff.equals("easy") && newScore < currUser.getEasyHighScore()){
            currUser.setEasyHighScores(newScore);
        }
        else if (diff.equals("medium") && newScore < currUser.getMediumHighScore()){
            currUser.setMediumHighScores(newScore);
        }
        else if (diff.equals("hard") && newScore < currUser.getHardHighScore()) {
